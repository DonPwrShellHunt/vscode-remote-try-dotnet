...
ms-dotnettools.csdevkit is the C Sharp Dev Kit

### Gotchas on my MBP configuration

To successfully test via debug, I had to alter the URL I was hitting from

`https://localhost:5000 to https://127.0.0.1:5000`
